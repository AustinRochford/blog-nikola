...
BLOG_AUTHOR = "Austin Rochford"  # (translatable)
BLOG_TITLE = "Austin Rochford"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://austinrochford.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://austinrochford.com/"
BLOG_EMAIL = "austin.rochford@gmail.com"
BLOG_DESCRIPTION = "{Math, Data, Software}"  # (translatable)
...
# Default is:
FILES_FOLDERS = {'resources': 'resources'}
...
DEPLOY_COMMANDS = {
    'default': [
        'aws s3 sync --dryrun --size-only output/ s3://austinrochford.com',
        ],
    'prod': [
        'aws s3 sync --size-only output/ s3://austinrochford.com',
        'aws cloudfront create-invalidation --distribution-id E3TKR0UZQ59DPP --paths "/*"',
    ],
}
...
# (translatable)
CONTENT_FOOTER = 'Contents licensed <a href="https://creativecommons.org/licenses/by-sa/4.0/" rel="nofollow">CC BY-SA 4.0</a><br>Powered by <a href="https://getnikola.com" rel="nofollow">Nikola</a>         {license}'
